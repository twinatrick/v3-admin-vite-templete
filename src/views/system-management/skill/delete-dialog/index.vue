...
const createdByEmail = computed(() => getCreatorEmail(skillData.value.createdBy))
...
<template>
  <el-dialog v-model="visible" title="確認刪除" width="500px">
    <div class="mb-4">
      <p class="text-lg mb-2">確定要刪除以下技能嗎？</p>
      ...
      <el-alert class="mt-4" type="warning" :closable="false">
        <template #title>
          <span class="font-bold">警告：刪除技能將會同時刪除所有相關的技能等級！</span>
        </template>
      </el-alert>
    </div>

...
async function handleConfirm() {
  ...
  if (!valid) return
  await service.create({ name: form.name, websites: form.websites, description: form.description || undefined })
  visible.value = false
  emit("done")
}
...
<template>
  <el-dialog v-model="visible" title="新增公司" width="500px" @closed="formRef?.clearValidate()">
